...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    @Bean
    public ProducerFactory<String, InditexAvroModel> producerFactory() {
        ...
        System.out.println("$$$$$$$ !!!!!!!!!!!!!!!!!!!!!!!! lala !!!!!!!!!!!!!!!!! $$$$$$" + kafkaConfigData.getBootstrapServers());
        Map<String, Object> props = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, InditexAvroModel> kafkaTemplate() {
